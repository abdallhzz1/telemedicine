      ...
      <GlassCard className="max-w-2xl mx-auto p-4 md:p-8">
        <div className="flex flex-col items-center text-center mb-6 md:mb-8">
          <div className="relative group mb-4">
            <Avatar className="h-20 w-20 md:h-24 md:w-24 border-4 border-primary/20 p-1 shadow-glow">
        ...
        <div className="space-y-1 md:space-y-2">
          ...
          {profile?.specialization && (
            <div className="flex justify-between items-center py-3.5 md:py-4 border-b border-border/30">
              <span className="text-[11px] md:text-sm text-muted-foreground uppercase tracking-wider font-semibold">{t('booking.specialization')}</span>
              <span className="text-[13px] md:text-base font-medium text-accent">{profile.specialization}</span>
            </div>
          )}
          <div className="flex justify-between items-center py-3.5 md:py-4 border-b border-border/30">
