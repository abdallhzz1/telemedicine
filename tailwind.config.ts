...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "gradient-primary": "linear-gradient(135deg, hsl(186, 100%, 42%) 0%, hsl(189, 94%, 43%) 100%)",
        "gradient-hover": "linear-gradient(135deg, hsl(189, 94%, 43%) 0%, hsl(186, 100%, 42%) 100%)",
        "gradient-radial": "radial-gradient(ellipse at center, var(--tw-gradient-stops))",
        "shimmer": "linear-gradient(90deg, transparent 0%, rgba(6, 182, 212, 0.1) 50%, transparent 100%)",
      },
      boxShadow: {
